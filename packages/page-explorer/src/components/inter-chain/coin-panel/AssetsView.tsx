  ...
  return (
    <div className='assets-view'>
      ...
      <div className='transferable'>
        <p>Transferable</p>
        <h2>{(sbtcAssets.balance - sbtcAssets.reserved).toFixed(4)} sBTC <span className='dollar small-px'> (≈ ${Number(price * sbtcAssets.reserved).toFixed(2)}) </span> </h2>
      </div>
      <div className='reserved'>
        <p>Withdrawal Reserved</p>
        <h2>{sbtcAssets.reserved} sBTC <span className='dollar small-px'> (≈ ${Number(price * sbtcAssets.reserved).toFixed(2)}) </span> </h2>
      </div>
    </div>
  );
};
